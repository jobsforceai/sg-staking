...
Sagenex should store `purchaseCode` against the deposit and email it to the user. Email wording should not say "Use this code on SG Staking"; the code is already generated by SG Staking after approval and is meant for the next SGX/card redemption step.
